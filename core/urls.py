...
urlpatterns = [
    ...
    path('apply/cma/form/', views.fill_form_cma, name='fill_form_cma'),
    path('apply/simple/<str:program_code>/', views.fill_form_simple, name='fill_form_simple'),
    path('apply/simple/<str:program_code>/submit/', views.submit_form_simple, name='submit_form_simple'),
    path('apply/cma/submit-form/', views.submit_form_cma, name='submit_form_cma'),
